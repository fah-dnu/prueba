...
namespace dataServices_Class
{
    public class DAOUtilerias
    {
        ...
        public Int64 InsertaCorteCuenta(String ClaveCorteTipo, DateTime Fecha_corte, int ID_cuenta, String Fecha_Final, String DiaFechaCorte,
          String Fecha_Inicial,string DiaLimitePago)
        {
