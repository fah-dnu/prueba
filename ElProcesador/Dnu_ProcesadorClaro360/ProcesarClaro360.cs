...
using DNU_ProcesadorClaro360.LogicaNegocio;
using System.IO;
using DNU_ProcesadorClaro360.BaseDatos;
using DNU_ProcesadorClaro360.Entidades;

namespace DNU_ProcesadorClaro360
{
    public class ProcesarClaro360 : IProcesoNocturno
    {
