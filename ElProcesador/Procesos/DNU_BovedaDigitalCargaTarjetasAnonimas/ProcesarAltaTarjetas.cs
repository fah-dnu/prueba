...
using DNU_BovedaDigitalCargaTarjetasAnonimas.LogicaNegocio;
...
namespace DNU_BovedaDigitalCargaTarjetasAnonimas
{
    //
        ...
        public bool Iniciar()
        {
           ...
           // LogueoPrAltaTarjParabilia.Error("[ProcesarAltaTarjetas] [PROCESADORNOCTURNO] [] [Iniciar, Error al Iniciar Procesar de Archivo, Mensaje:");
            ...
            try
            {
                ...
                path = PNConfig.Get("CARGABOVEDADIGITAL", "DirectorioEntrada");
                LNArchivo _AltaTarjeta = new LNArchivo(path, String.Empty);
                _AltaTarjeta.crearDirectorio();
                Logueo.Evento("[" + ip + "] [ProcesarAltaTarjetasDigital] [PROCESADORNOCTURNO] [" + log + "] [Inicia el renombramiento del Archivo procesado: ]");
            ...
            {
                Logueo.Error("[" + ip + "] [ProcesarAltaTarjetas] [PROCESADORNOCTURNO] [" + log + "] [Iniciar, Error al Iniciar Procesar de Archivo, Mensaje: " + ex.Message + " TRACE: " + ex.StackTrace + "]");
