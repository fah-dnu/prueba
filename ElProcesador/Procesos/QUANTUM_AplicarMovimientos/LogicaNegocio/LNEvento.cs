  ...
  public class LNEvento
    {
        ...
        public static Respuesta EjecuarEvento(String CadenaComercial, String ClaveEvento, String IDCliente, String Tarjeta, Decimal Importe, Parametro[] losParamentros, Int64 RefNumerica, String Concepto, String Observaciones, String elUsuario)
        {
            ...
            try
            {
                ...
                //valida los importes de las Facturas, si el importe de la factura es mayor, menor o igual al importe autorizado.
                //consultar la operacion de la TARJETA+AUTORIZACION
                //Guardar en el los Paramentros el @ImporteFactura y el @ImporteAutorizado
                ...
                Dictionary<String, Parametro> losParametrosOperacion = DAOEvento.ListaDeParamentrosContrato(CadenaComercial, Tarjeta, ClaveEvento, elUsuario);
                    ...
                    using (SqlTransaction transaccionSQL = conn.BeginTransaction())
                    {
                        ...
                        finally
                        {
                            ...
                            if (Resp == 0)
                            {
                                ...
                                laRespuesta.Descripcion = "AUTORIZADA " + (TodosLosParametros.ContainsKey("@DescEvento") ? TodosLosParametros["@DescEvento"].Valor : "").ToUpper(); 
                            ...
                            else
                            {
                                ...
                                laRespuesta.Descripcion = "DECLINADA " + (TodosLosParametros.ContainsKey("@DescEvento") ? TodosLosParametros["@DescEvento"].Valor : "").ToUpper(); 
