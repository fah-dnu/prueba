...
namespace QUANTUM_NuevoCliente.BaseDatos
{
    public class BDNuevoCliente
    {
        ...
        public static String strBDLectura
        {
            get
            {
                return PNConfig.Get("NUEVOCLNT", "BDReadAutorizador");//ConfigurationManager.AppSettings["DBEmpleadosRead"].ToString();// Config.GetValor("ALTAEMPLEADOS", "strBDLectura");
            }
        }
        ...
        public static String strBDEscritura
        {
            get
            {
                return PNConfig.Get("NUEVOCLNT", "BDWriteAutorizador");// ;
            }
        }
