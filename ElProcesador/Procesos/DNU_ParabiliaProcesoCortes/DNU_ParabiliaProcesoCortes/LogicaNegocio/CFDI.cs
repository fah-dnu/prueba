       ...
       public CFDI(Factura laFactura, bool facturaEnBlanco)
        {
            ...
            try
            {
                ...
                elXML.Append(" TipoDeComprobante=\"" + laFactura.getParametro("@TipoComprobante") + "\"");
                elXML.Append(" TipoCambio=\"1\"");
                elXML.Append(" Moneda=\"MXN\"");
                elXML.Append(" LugarExpedicion=\"" + laFactura.getParametro("@LugarExpedicion") +"\">");
            ...
            {
                LogueProcesaEdoCuenta.Error("[" + ip + "] [ProcesoCortes] [PROCESADORNOCTURNO] [" + log + "] [FACTURACION" + err.Message + " " + err.StackTrace + "]");
        ...
        String setEmisor(Colectiva elEmisor)
        {
            ...
            try
            {
                ...
                unEmisor.Append("RegimenFiscal=\"" + laFacturaLocal.getParametro("@RegimenFiscal") + "\">");
        ...
        private String SetReceptor(Colectiva Receptora)
        {
            ...
            try
            {
                ...
                unReceptor.Append(" UsoCFDI=\"" + laFacturaLocal.getParametro("@UsoCFDI") + "\">");
