...
namespace TELEVIP_ImportaTagsAfiliados.BaseDatos
{
    public class BDTelevip
    {
        ...
        public static String strBDLectura
        {
            get
            {
                return PNConfig.Get("DISPERSION", "BDReadTelevia");//ConfigurationManager.AppSettings["DBEmpleadosRead"].ToString();// Config.GetValor("ALTAEMPLEADOS", "strBDLectura");
            }
        }
        ...
        public static String strBDEscritura
        {
            get
            {
                return PNConfig.Get("DISPERSION", "BDWriteTelevia");// ;
            }
        }
