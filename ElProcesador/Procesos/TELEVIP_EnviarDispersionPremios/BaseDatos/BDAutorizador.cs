...
namespace TELEVIP_ImportaTagsAfiliados.BaseDatos
{
    class BDAutorizador
    {
        ...
        public static String strBDLectura
        {
            get
            {
                return PNConfig.Get("DISPERSION", "BDReadAutorizador");//ConfigurationManager.AppSettings["DBEmpleadosRead"].ToString();// Config.GetValor("ALTAEMPLEADOS", "strBDLectura");
            }
        }
        ...
        public static String strBDEscritura
        {
            get
            {
                return PNConfig.Get("DISPERSION", "BDWriteAutorizador");// ;
            }
        }
