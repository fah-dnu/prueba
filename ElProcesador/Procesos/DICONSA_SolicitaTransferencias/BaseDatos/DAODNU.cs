...
namespace DICONSA_SolicitaTransferencias.BaseDatos
{
    class DAODNU
    {
        /// <summary>
        ...
        public static List<TiendaDiconsa> ListaTiendasActivas()
        {
            try
            {
                ...
                database.AddInParameter(command, "@TipoProceso", DbType.Int32, 3);
        ...
        public static void ActualizaEstatusTienda(Int32 IdColectiva)
        {
            ...
            {
                throw new Exception("DAODNU.ActualizaEstatusTienda() ERROR:" + ex.Message);
            }
        }
    }
}
