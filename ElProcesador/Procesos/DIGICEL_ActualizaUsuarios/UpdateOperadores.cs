...
using DIGICEL_ActualizaUsuarios.LogicaNegocio;
using System.IO;

namespace DIGICEL_ActualizaUsuarios
{
    class UpdateOperadores : IProcesoNocturno
    {
        ...
        bool IProcesoNocturno.Procesar()
        {
            ...
            try
            {
                ...
                try
                {
                    DirectoryInfo directory = new DirectoryInfo(PNConfig.Get("DGUSERS", "Directorio"));

                    FileInfo[] files = directory.GetFiles("DIGICEL_*.*");
