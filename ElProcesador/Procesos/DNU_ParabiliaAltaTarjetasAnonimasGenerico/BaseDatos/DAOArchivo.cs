...
namespace DNU_ParabiliaAltaTarjetasAnonimasGenerico.BaseDatos
{
    public class DAOArchivo
    {
        ...
        internal static string[] AltaTarjeta(Archivo item, String claveColectiva, string tipoManufactura, String connString, bool tarjetaActiva = false, string colectivaCuentahabiente = null, SqlConnection connSQL = null, SqlTransaction transaccionSQL = null, string subproducto = null, string log="", string ip="")
        {
            ...
            try
            {
               ...
               // command.Parameters.Add(new SqlParameter("@cuenta", item.Cuenta));
                ...
                command.Parameters.Add(new SqlParameter("@bin", item.NumeroTarjeta));
                ...
                paramSSN.Size = string.IsNullOrEmpty(item.NumeroTarjeta)
                                    ? 50
                ...
                paramSSNCuenta.Size = string.IsNullOrEmpty(item.Cuenta)
                                    ? 50
                                    : item.Cuenta.Length;
        ...
        internal static  DataTable  AgregarMedioAcceso(string cuentaInterna,string idMa,string tipoMARegreso, SqlConnection connSQL = null, SqlTransaction transaccionSQL = null, string subproducto = null, string log="", string ip="")
        {
            ...
            try
            {
                ...
                procedimientoAlmacenado = "[ws_Parabilia_ObtenerDatosAltaMAParabiliaSNTran]";
                ...
                command.Parameters.Add(new SqlParameter("@idMedioAcceso", idMa));

                SqlParameter paramSSN = command.CreateParameter();
                paramSSN.ParameterName = "@medioAccesoNuevo";
                paramSSN.DbType = DbType.AnsiStringFixedLength;
                paramSSN.Direction = ParameterDirection.Input;
                paramSSN.Value = cuentaInterna;
                paramSSN.Size = 50;
                command.Parameters.Add(paramSSN);
