...
{
    public class SeguridadCifrado
    {
        private static string clave = "cifradodes78963";
        ...
        public static string descifrar(string cadena)
        {
            try
            {
                ...
                Logueo.Error("[TarjetasNominativas][PROCESADORNOCTURNO] mensaje:" + ex.Message + " " + ex.StackTrace);
                return "";
            }
        }
    }
