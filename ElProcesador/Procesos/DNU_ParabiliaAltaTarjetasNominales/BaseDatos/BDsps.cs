...
namespace DNU_ParabiliaAltaTarjetasNominales.BaseDatos
{
 ...
 bulkCopy.BulkCopyTimeout = 30000;
        ...
        public static void insertarRespuestaCacaoAltas(XmlDocument pResponse, SqlConnection pConn, string pIdDetalle, string pNombre)
        {


            SqlCommand query = new SqlCommand("procnoc_travel_InsertaRespuestaCACAOAltas", pConn);
            query.CommandType = CommandType.StoredProcedure;
        ...
        {
            String conexionSting = PNConfig.Get("ALTAEMPLEADOCACAO", "BDReadAutorizador");
        ...
        public static void insertarRespuestaCacaoAltasReproceso(SqlConnection pConn, string pIdDetalle, string claveEmpleadora
                                                            , string regEmpleado)
        {
            SqlCommand query = new SqlCommand("procnoc_travel_InsertaRespuestaCACAOAltasReproceso", pConn);
            query.CommandType = CommandType.StoredProcedure;
        ...
        public static DataSet obtenerDatosTarjetaEventoAsigLimCreditoParaExecute(ParamParabiliaAltas pParametros, SqlConnection pConn, SqlTransaction transaccionSQL = null)
        {
            ...
            query.CommandType = CommandType.StoredProcedure;
            query.Parameters.AddWithValue("@tarjeta", SeguridadCifrado.descifrar(pParametros.Tarjeta));
            query.Parameters.AddWithValue("@claveEvento", PNConfig.Get("ALTAEMPLEADOCACAO", "eventoAsignaLimiteCredito"));
