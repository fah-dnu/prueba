...
namespace DNU_ParabiliaAltaTarjetasAnonimas.BaseDatos
{
        ...
        internal static string[] AltaTarjeta(Archivo item, String claveColectiva, string tipoManufactura, String connString, bool tarjetaActiva = false, string colectivaCuentahabiente = null, SqlConnection connSQL = null, SqlTransaction transaccionSQL = null, string subproducto = null, string log="", string ip="")
        {
            ...
            try
            {
               ...
               // command.Parameters.Add(new SqlParameter("@cuenta", item.Cuenta));
                ...
                command.Parameters.Add(new SqlParameter("@bin", item.NumeroTarjeta.Length >= 8 ? item.NumeroTarjeta.Substring(0, 8) : item.NumeroTarjeta));
