...
namespace MonitoreaCuentas.BaseDatos
{
    class BDEmpleados
    {
        ...
        public static String strBDLectura
        {
            get
            {
                return PNConfig.Get("CTAMONITOR", "BDReadAutorizador");//ConfigurationManager.AppSettings["DBEmpleadosRead"].ToString();// Config.GetValor("ALTAEMPLEADOS", "strBDLectura");
            }
        }
        ...
        public static String strBDEscritura
        {
            get
            {
                return PNConfig.Get("CTAMONITOR", "BDWriteAutorizador");// ;
            }
        }
