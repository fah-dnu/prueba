...
{
    public class BDBloqueoDesbloqueo
    {
        ...
        public static String strBDLectura
        {
            get
            {
                return PNConfig.Get("BLOQUEO", "BDReadAutorizador");//ConfigurationManager.AppSettings["DBEmpleadosRead"].ToString();// Config.GetValor("ALTAEMPLEADOS", "strBDLectura");
            }
        }
        ...
        public static String strBDEscritura
        {
            get
            {
                return PNConfig.Get("BLOQUEO", "BDWriteAutorizador");// ;
            }
        }
