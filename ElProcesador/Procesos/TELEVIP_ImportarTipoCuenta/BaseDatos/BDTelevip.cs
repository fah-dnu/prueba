...
namespace TELEVIP_ImportarTipoCuenta.BaseDatos
{
    public class BDTelevip
    {
        ...
        public static String strBDLectura
        {
            get
            {
                return PNConfig.Get("UPDATECTA", "BDReadTelevia");//ConfigurationManager.AppSettings["DBEmpleadosRead"].ToString();// Config.GetValor("ALTAEMPLEADOS", "strBDLectura");
            }
        }
        ...
        public static String strBDEscritura
        {
            get
            {
                return PNConfig.Get("UPDATECTA", "BDWriteTelevia");// ;
            }
        }
