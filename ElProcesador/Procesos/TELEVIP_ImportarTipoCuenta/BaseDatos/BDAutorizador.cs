...
namespace TELEVIP_ImportarTipoCuenta.BaseDatos
{
    class BDAutorizador
    {
        ...
        public static String strBDLectura
        {
            get
            {
                return PNConfig.Get("UPDATECTA", "BDReadAutorizador");//ConfigurationManager.AppSettings["DBEmpleadosRead"].ToString();// Config.GetValor("ALTAEMPLEADOS", "strBDLectura");
            }
        }
        ...
        public static String strBDEscritura
        {
            get
            {
                return PNConfig.Get("UPDATECTA", "BDWriteAutorizador");// ;
            }
        }
